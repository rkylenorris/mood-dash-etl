...
CREATE TABLE IF NOT EXISTS tag_groups (id INTEGER PRIMARY KEY, name TEXT);
...
CREATE TABLE IF NOT EXISTS mood_groups (id INTEGER PRIMARY KEY, name TEXT, value INTEGER);
